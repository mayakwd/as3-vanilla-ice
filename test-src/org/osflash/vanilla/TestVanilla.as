package org.osflash.vanilla
{
	...
	import org.osflash.vanilla.testdata.HexData;
	...
	import org.osflash.vanilla.testdata.SimpleTypesConversion;
	...
	public class TestVanilla
	{
		...
		[Test]
		public function hexNumbers() : void {
			_marshaller.allowSimpleTypesConversion = true;

			const source : Object ={a: "0x0F", b: "0x0F", c: "0x0F"};
			const result : HexData = _marshaller.extract(source, HexData);
			
			assertEquals(15, result.a);
			assertEquals(15, result.b);
			assertEquals(15, result.c);
		}
		...
		public function mismatchedDataType() : void
		{
			...
			try {
				...
				_marshaller.allowSimpleTypesConversion = false;
		...
		[Test (description="Marshalling with forced types conversions")]
